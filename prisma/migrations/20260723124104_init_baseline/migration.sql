...
CREATE TABLE "user_project_roles" (
    ...
    CONSTRAINT "user_project_roles_pkey" PRIMARY KEY ("user_id","project_id","role_id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "organisations_contact_email_key" ON "organisations"("contact_email");

-- CreateIndex
CREATE INDEX "projects_country_id_idx" ON "projects"("country_id");

-- CreateIndex
CREATE INDEX "projects_admin_location_id_idx" ON "projects"("admin_location_id");
...
-- CreateIndex
CREATE INDEX "users_admin_location_id_idx" ON "users"("admin_location_id");
...
-- AddForeignKey
ALTER TABLE "organisations" ADD CONSTRAINT "organisations_country_id_fkey" FOREIGN KEY ("country_id") REFERENCES "countries"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "organisations" ADD CONSTRAINT "organisations_admin_location_id_fkey" FOREIGN KEY ("admin_location_id") REFERENCES "locations"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "projects" ADD CONSTRAINT "projects_country_id_fkey" FOREIGN KEY ("country_id") REFERENCES "countries"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "projects" ADD CONSTRAINT "projects_admin_location_id_fkey" FOREIGN KEY ("admin_location_id") REFERENCES "locations"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "project_tree_types" ADD CONSTRAINT "project_tree_types_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "projects"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "project_tree_types" ADD CONSTRAINT "project_tree_types_tree_type_id_fkey" FOREIGN KEY ("tree_type_id") REFERENCES "tree_types"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "users" ADD CONSTRAINT "users_admin_location_id_fkey" FOREIGN KEY ("admin_location_id") REFERENCES "locations"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "user_project_roles" ADD CONSTRAINT "user_project_roles_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "user_project_roles" ADD CONSTRAINT "user_project_roles_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "projects"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "user_project_roles" ADD CONSTRAINT "user_project_roles_role_id_fkey" FOREIGN KEY ("role_id") REFERENCES "roles"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "user_project_roles" ADD CONSTRAINT "user_project_roles_assigned_by_fkey" FOREIGN KEY ("assigned_by") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "user_organisations" ADD CONSTRAINT "user_organisations_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "user_organisations" ADD CONSTRAINT "user_organisations_organisation_id_fkey" FOREIGN KEY ("organisation_id") REFERENCES "organisations"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
